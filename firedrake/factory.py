...
def FunctionSpaceFactory(rank, mesh, family, **kwargs):
    functionspaces = {
        '1': CreateFunctionSpace(mesh, family, **kwargs)
        '2': CreateVectorFunctionSpace(mesh, family, **kwargs)
        '3': CreateTensorFunctionSpace(mesh, family, **kwargs)
        'mixed': CreateMixedFunctionSpace(mesh, family, **kwargs)
    }
    return
...
class AbstractFunctionSpaceFactory(ABC):
    @abstractmethod
